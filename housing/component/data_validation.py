...
class DataValidation:
    ...
    def is_train_test_file_exist(self)->bool:
        try:
            ...
            is_train_file_exist = os.path.join(train_file_path)
            ...
            if not is_available:
                message = f"The train file {train_file_path} and test file {test_file_path} is not present"
    ...
    def initiate_data_validation(self):
        try:
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                report_page_file_path=self.data_validation_config.report_page_file_path,
                is_validated=True,
                message=f"Data validation performed Successsfully"
            )
            logging.info(f"Data Vlaidation artifact : {data_validation_artifact}")
        except Exception as e:
            raise HousingException(e,sys) from e